...
ROOT_DIR = environ.Path(__file__) - 3  # (errol_frontend/config/settings/base.py - 3 = errol_frontend/)
APPS_DIR = ROOT_DIR.path('errol_frontend')
...
DATABASE_ROUTERS = ['errol_frontend.errol.routers.DieselRouter']
...
MIGRATION_MODULES = {
    'sites': 'errol_frontend.contrib.sites.migrations'
}
...
ADMINS = [
    ("""zoidbergwill""", 'zoidbergwill@gmail.com'),
]
...
# Celery
# ------------------------------------------------------------------------------
INSTALLED_APPS += ['errol_frontend.taskapp.celery.CeleryAppConfig']
if USE_TZ:
...
# https://django-allauth.readthedocs.io/en/latest/configuration.html
ACCOUNT_ADAPTER = 'errol_frontend.users.adapters.AccountAdapter'
# https://django-allauth.readthedocs.io/en/latest/configuration.html
SOCIALACCOUNT_ADAPTER = 'errol_frontend.users.adapters.SocialAccountAdapter'
