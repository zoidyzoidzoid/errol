//! https://raw.githubusercontent.com/ramosbugs/oauth2-rs/master/examples/github.rs
//!
...
use self::oauth2::basic::BasicClient;
#[allow(unused_imports)] use self::oauth2::prelude::*;
use self::oauth2::{AuthUrl, AuthorizationCode, ClientId, ClientSecret, CsrfToken, RedirectUrl, Scope,
             TokenUrl};
use self::url::Url;
